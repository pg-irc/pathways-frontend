...
import { ExplainFeedbackComponent } from '../feedback/explain_feedback_component';
...
export const MainPageSwitcherComponent: React.StatelessComponent<Props> = (props: Props): JSX.Element => (
    <Switch>
        ...
        <Route exact path={routePathDefinition(Routes.ExplainFeedback)} component={ExplainFeedbackComponent} />
