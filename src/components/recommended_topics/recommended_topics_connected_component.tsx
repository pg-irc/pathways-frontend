...
import { TaskListActions, SaveTaskListOffsetActions } from '../topics/task_list_component';
...
import { OpenHeaderMenuAction, openHeaderMenu, saveHomePageOffset, SaveHomePageAction } from '../../stores/user_experience/actions';
...
const mapDispatchToProps = (dispatch: Dispatch<Actions>): RecommendedTopicsActions & TaskListActions => ({
    ...
    saveListOffset: (offset: number): SaveTaskListOffsetActions => dispatch(saveHomePageOffset(offset)),
});
