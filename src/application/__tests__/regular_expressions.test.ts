...
describe('phone number regular expression', () => {
    ...
    it('matches phone with country code, area code, and number in mixed format: x xxx-xxx xxxx', () => {
        expect(phoneNumberRegex.test('1 111-111 1111')).toBe(true);
    });
    ...
    it('does not match a valid phone proceded by a non numeric value', () => {
    ...
    it('does not match non dash or space separated phone', () => {
