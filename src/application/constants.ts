...
export const SUGGEST_AN_UPDATE = 'SUGGEST_AN_UPDATE';
export const CHOOSE_CHANGE_NAME_AND_DETAILS = 'CHOOSE_CHANGE_NAME_AND_DETAILS';
export const CHOOSE_REMOVE_SERVICE = 'CHOOSE_REMOVE_SERVICE';
export const CHOOSE_OTHER_CHANGES = 'CHOOSE_OTHER_CHANGES';
export const DISCARD_CHANGES = 'DISCARD_CHANGES';
export const CLOSE = 'CLOSE';
export const BACK = 'BACK';
export const SUBMIT = 'SUBMIT';
export const FINISH_FEEDBACK = 'FINISH_FEEDBACK';
