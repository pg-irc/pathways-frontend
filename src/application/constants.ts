...
export const SAVE_LIST_OFFSET = 'SAVE_LIST_OFFSET';
export const CLEAR_LIST_OFFSET = 'CLEAR_LIST_OFFSET';
export const SAVE_SEARCH_OFFSET = 'SAVE_SEARCH_OFFSET';
export const SAVE_TOPIC_SERVICES_OFFSET = 'SAVE_TOPIC_SERVICES_OFFSET';
export const SAVE_BOOKMARKED_SERVICES_OFFSET = 'SAVE_BOOKMARKED_SERVICES_OFFSET';

export const SET_BOOKMARKS_TAB = 'SET_BOOKMARKS_TAB';