...
export const GET_SERVER_VERSION_REQUEST = 'GET_SERVER_VERSION_REQUEST';
export const GET_SERVER_VERSION_SUCCESS = 'GET_SERVER_VERSION_SUCCESS';
export const GET_SERVER_VERSION_FAILURE = 'GET_SERVER_VERSION_FAILURE';
