...
export const ENABLE_SERVICE_FEEDBACK = 'ENABLE_SERVICE_FEEDBACK';
export const DISABLE_SERVICE_FEEDBACK = 'DISABLE_SERVICE_FEEDBACK';
export const OPEN_DISCARD_FEEDBACK_MODAL = 'OPEN_DISCARD_FEEDBACK_MODAL';
export const CLOSE_DISCARD_FEEDBACK_MODAL = 'CLOSE_DISCARD_FEEDBACK_MODAL';
