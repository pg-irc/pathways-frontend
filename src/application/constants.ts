...
export const SAVE_HOMEPAGE_OFFSET = 'USER_EXPERIENCE:SAVE_HOMEPAGE_OFFSET';
export const SAVE_TOPIC_DETAIL_OFFSET = 'SAVE_TOPIC_DETAIL_OFFSET';
export const SAVE_SEARCH_OFFSET = 'USER_EXPERIENCE:SAVE_SEARCH_OFFSET';
export const SAVE_TOPIC_SERVICES_OFFSET = 'USER_EXPERIENCE:SAVE_TOPIC_SERVICES_OFFSET';
export const SAVE_BOOKMARKED_SERVICES_OFFSET = 'USER_EXPERIENCE:SAVE_BOOKMARKED_SERVICES_OFFSET';
