...
export const selectArticlesForCurrentExploreSection = (store: Store, routerProps: RouterProps): ReadonlyArray<ArticleListItem> => {
    ...
    const matchingArticles = findItemsByLearnTaxonomyTerm(exploreSection.taxonomyTerms, articles);
